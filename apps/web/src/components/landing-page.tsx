...
<div style={{ position: "relative", maxWidth: 640, zIndex: 1, textAlign: "left" }} className="animate-fade-up">
          ...
          <h1 style={{ fontSize: "clamp(2.5rem, 5.5vw, 4.2rem)", fontWeight: 900, lineHeight: 1.1, color: "#0d1117", marginBottom: "1.5rem", letterSpacing: "-0.02em" }}>
            {lang === "en" ? (
              <>
                You deserve to be{" "}
          ...
          <p style={{ fontSize: "1.15rem", color: "#4b5563", maxWidth: 680, marginBottom: "2.5rem", lineHeight: 1.7 }}>
            {t.hero.subhead}
          </p>
        ...
        <div style={{ flex: "0 0 450px", display: "flex", justifyContent: "center", position: "relative", zIndex: 1 }} className="hidden-mobile">
            ...
            <img src="/images/shield.jpg" className="float-anim" alt="SafeHer Protection" style={{ height: 480, objectFit: "contain", position: "relative", zIndex: 1, borderRadius: 24, filter: "drop-shadow(0 25px 50px rgba(15,118,110,0.25))" }} />
          </div>
      </div>
      </section>

      {/* ── Stats (dark navy section) ───────────────────────────────── */}
      <section style={{ background: "linear-gradient(180deg, var(--bg-dark) 0%, #061220 100%)", padding: "5rem 1.5rem", position: "relative", zIndex: 2 }}>
      ...
      {/* ── How It Works ───────────────────────────────────────────── */}
      <section id="how-it-works" style={{ padding: "6.5rem 1.5rem", background: "var(--bg-soft)", position: "relative" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", gap: "4rem", alignItems: "center" }} className="mobile-stack">
            <div className="hidden-mobile float-delayed" style={{ flex: "0 0 360px", position: "relative" }}>
          ...
          <div style={{ flex: 1, display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: "1.75rem" }} className="stagger-children">
            {t.howItWorks.steps.map((step) => (
              <div key={step.step} className="glass-panel card-3d" style={{ borderRadius: 16, padding: "2.25rem", background: "var(--bg-card)", border: "1.5px solid #e5e7eb", transition: "all 0.3s" }}>
      ...
      {/* ── Features ───────────────────────────────────────────────── */}
      <section id="features" style={{ padding: "6.5rem 1.5rem", background: "transparent" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: "4.5rem" }}>
          ...
          <div style={{ display: "flex", gap: "4rem", alignItems: "center" }} className="mobile-stack">
            <div style={{ flex: "0 0 400px", position: "relative" }} className="hidden-mobile float-anim">
              ...
              <img src="/images/lock.jpg" alt="Security & Encryption" style={{ width: "100%", maxWidth: "500px", objectFit: "contain", position: "relative", zIndex: 1, mixBlendMode: "multiply", borderRadius: "20px", filter: "drop-shadow(0 30px 40px rgba(15,118,110,0.15))" }} />
            </div>
            ...
            {t.features.items.map((f) => (
              <div key={f.title} className="glass-panel card-3d" style={{ borderRadius: 16, padding: "2rem", background: "var(--bg-card)", border: "1.5px solid #e5e7eb", transition: "all 0.3s" }}>
      ...
      <section style={{ padding: "6.5rem 1.5rem", background: "var(--bg-soft)", borderTop: "1px solid #e5e7eb", borderBottom: "1px solid #e5e7eb" }}>
            ...
            {t.faq.items.map((item, idx) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <p style={{ padding: "1.25rem 1.5rem", fontSize: "0.925rem", color: "#4b5563", lineHeight: 1.7, background: "var(--bg-soft)" }}>
                      {item.a}
                    </p>
                  </div>
                </div>
      ...
      <section id="for-police" style={{ background: "linear-gradient(180deg, var(--bg-dark) 0%, #061220 100%)", padding: "6rem 1.5rem", position: "relative", zIndex: 2 }}>
      ...
      {/* ── Witness CTA ────────────────────────────────────────────── */}
      <section style={{ padding: "6rem 1.5rem", background: "transparent", position: "relative" }}>
        <div style={{ maxWidth: 900, margin: "0 auto", display: "flex", alignItems: "center", gap: "3rem", border: "1.5px solid #e5e7eb", borderRadius: 24, padding: "3.5rem", background: "rgba(255,255,255,0.7)", backdropFilter: "blur(30px)", boxShadow: "0 20px 60px rgba(15,118,110,0.1)", border: "1px solid rgba(255,255,255,0.9)" }} className="mobile-stack">
      ...
      {/* ── Footer ─────────────────────────────────────────────────── */}
      <footer style={{ background: "linear-gradient(180deg, var(--bg-dark) 0%, #061220 100%)", borderTop: "1px solid #1f2937", position: "relative", zIndex: 2 }}>
